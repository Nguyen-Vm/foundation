...
public final class JAXBUtils {
    ...
    public static <T> T unMarshall(String xml, final Class<T> clazz) {
        try {
    ...
    public static <T> T unMarshall(String xml, final Class<T> clazz, final ValidationEventHandler handler) {
        try {
    ...
    public static <T> T unMarshall(final InputStream is, final Class<T> clazz) {
        try {
    ...
    public static <T> T unMarshall(final InputStream is, final Class<T> clazz, final ValidationEventHandler handler) {
        try {
